  ...
  <ArticleMainStyled>
    ...
    <TextWrapper>
      ...
      <P>
        ...
        eum oratio epicurei deserunt ad,
        vidit dicam conclusionemque ex qui.
        Alienum accusam ad has.
        {' '}
        <Highlighted>Highlighted text</Highlighted>
        {' '}
        Mei ne eros pertinacia sadipscing, ei est doctus
        latine aperiam, te quo diam possit noluisse.
        An soluta maiorum consetetur his, tale liber vim et.
      </P>
      ...
      <P>
        ...
        eum oratio
        {' '}
        <ItalicBold> some italic bold text </ItalicBold>
        {' '}
        epicurei deserunt ad,
        vidit dicam conclusionemque ex qui.
