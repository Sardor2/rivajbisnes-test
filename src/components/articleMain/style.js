...
export const StyledContainer = styled.article`
    ...
    /* padding-top: 20px; */
    /* padding-bottom: 20px; */
    /* padding-left: ${(props) => (props.paddingLeft100 ? '20px' : '0px')}; */
    /* padding-right: 0; */
    ...
    @media screen and ( max-width: 720px ) {
        ...
        margin-bottom: ${({ noPadding }) => (noPadding ? '16px' : '12px')};
    }

    @media screen and ( max-width: 600px ) {
        padding-left: ${({ categoryPage }) => (categoryPage ? '20px' : 0)};
        padding-right:20px;
        h2 {
            font-size:22px;
        }
    ...
    img {
        display: ${(props) => (props.imageHide ? 'none' : 'block')};
        width: ${(props) => (props.imageHide ? '0px' : '100%')};
        height: auto;
        /* margin-right: 20px; */
...
export const ContentWrapper = styled.div`
    margin-left: 0;
    @media screen and (max-width: 720px) {
        margin-left: ${(props) => (props.noPadding ? 0 : '18px')} ;
    }
...
export const ButtonsWrapper = styled.div`
    ...
    @media screen and (max-width: 720px) {
        ${({ categoryPage }) => categoryPage && 'flex-direction: column;'}
    }
`;
